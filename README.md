...
|---|---|---|---|
| [28 — Information Non-Monotonicity under Progressive Truthful Clues](./28_progressive_truthful_clue_reversal/) | **ARCHIVED / G0 PHENOMENON REAL / ALL FROZEN FOLLOW-UPS STOPPED** | G1 order was null, G2a destructive conjunction was `1/229`, and the final artifact-only shared-trap route found 17 qualifying boundaries/questions versus frozen 20/20 gates. No modern-model transfer or mechanism work is authorized. | [Archive summary](./28_progressive_truthful_clue_reversal/ARCHIVE_SUMMARY.md) |
