...
| 2 | [22 — Does the Model Encode New Evidence but Fail to Update Its Diagnosis?](./22_medeinst_evidence_update/) | **REGISTERED / RERUN REQUIRED** | G0a pair structure passed. The first Qwen3-14B G0b was measurement-invalid (`81.25%` invalid outputs); run the frozen measurement-repair v2 before any scientific verdict. |
