...
| 3 | [18 — Is Negative Behavioral Adaptation Intrinsically Harder?](./18_negative_behavioral_adaptation/) | With behavior, exposure and feedback magnitude matched, are LLMs worse at suppressing an action after negative experience than selecting one after positive experience? | **G0 INCONCLUSIVE / STOP.** Frozen three-family panel: Phi Δ=0.391, Gemma Δ=0.203, Qwen Δ=0.047; pooled Δ=0.214 [0.135, 0.292]. Cross-model survival failed and clean-null kill failed, so no rescue sweep. |
